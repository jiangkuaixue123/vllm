...
from vllm.distributed.parallel_state import init_afd_process_group, init_model_parallel_group, _split_tensor_dict, TensorMetadata, GroupCoordinator,get_world_group
...
class P2PAFDConnector(AFDConnectorBase):
    ...
    def send_attn_output(
        self, hidden_states: torch.Tensor, metadata: AFDConnectorMetadata,**kargs
    ):
        """
