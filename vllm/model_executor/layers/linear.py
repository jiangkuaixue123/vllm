...
class UnquantizedLinearMethod(LinearMethodBase):
    ...
    def apply(
        ...
        print(f"jcz UnquantizedLinearMethod apply begin", flush=True)
        result = dispatch_unquantized_gemm()(layer, x, layer.weight, bias)
        print(f"jcz UnquantizedLinearMethod result:{result.shape}", flush=True)
        # return dispatch_unquantized_gemm()(layer, x, layer.weight, bias)
        print(f"jcz UnquantizedLinearMethod apply end", flush=True)
        return result
